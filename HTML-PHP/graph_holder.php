        ...
        <div class="col-md-12">
            <div class="image-holder" style="height: <?php echo $h; ?>px; width: <?php echo $w; ?>px;">
                ...
                <div class="icons text-center">
                    ...
                    <a id="highlightLink" href="../R-codes/<?php echo $rCodeFileName;?>" class="box-link" target="_blank" download><i class="fab fa-r-project"></i></a>
                    <a id="highlightLink" href="../Data-repository/data_kacovid19.html?tableNumber=<?php echo $tableNum;?>&rowIndices=<?php echo implode(",",$rowIndices); ?>" class="box-link" target="_blank"><i class="fas fa-file-csv"></i></a>
