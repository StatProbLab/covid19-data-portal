   ...
   <div class="container mt-5">
      <div class="row">
        <div class="col-md-8 mx-auto text-center jumbotron bg-info text-white">
          <h2>Districtwise Infected Cases in Log Scale</h2>
    ...
    <div class="row">
        ...
        for ($i = 1; $i <= 30; $i++) {
            ...
            generateImageHolder("ka_infected_cases","$i-log.svg", "$i-log.html","karnataka_districtwise_infected_cases_log_scale.R",2,[1],400,500);
            echo '</div>';
        }
        ?>
    </div>
