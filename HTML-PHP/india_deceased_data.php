    ...
    <div class="row">
        <!-- Column for sections -->
         ...
         <!-- Column for graph -->
            ...
            <div id="graphCanvas">
                ...
                <?php generateImageHolder("india_deceased_data","india_deceased_ratio.gif","india_deceased_ratio.gif","rcode.R","test.csv",400,650)?>
            </div>
            </div>
        </div>
        <div class="row">
        <!-- Column for sections -->
         ...
         <!-- Column for graph -->
            ...
            <div id="graphCanvas">
                <!-- Graph will be displayed here -->
                <?php generateImageHolder("india_deceased_data","india_states_dr.png","india_states_dr.html","rcode.R","test.csv",500,700)?>
            </div>
            </div>
        </div>
    </div>
