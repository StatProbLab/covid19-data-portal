   ...
   <div class="container mt-5">
      <div class="row">
        <div class="col-md-8 mx-auto text-center jumbotron bg-info text-white">
          <h2>Infection Timeline - Districts of Karnataka</h2>
        ...
        <!-- Column for sections -->
         ...
         <!-- Column for graph -->
            ...
            <div id="graphCanvas">
                ...
                <?php generateImageHolder("ka_infected_cases","ka_infected.gif","ka_infected.gif","rcode.R","test.csv",400,650)?>
            </div>
            </div>
        </div>
    ...
    <div class="row">
        <!-- Column for sections -->
         ...
         <!-- Column for graph -->
            ...
            <div id="graphCanvas">
                <!-- Graph will be displayed here -->
                <?php generateImageHolder("ka_infected_cases","ka-all.svg","ka-all.html","rcode.R","test.csv",400,650)?>
            </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
      ...
      <div class="col-md-12 icu-timeline">
        <h3>Infected Cases-Karnataka States</h3>
        <p>In Karnataka, the utilization of Intensive Care Units (ICUs) within the district healthcare system has evolved through 
          ...
          <a href="ka_infected_cases_plots.php" target="_blank">Click here to see the graphs for all districts.</a>
        </p>
      </div>
      </div>
  </div>
