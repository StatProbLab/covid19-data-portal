...
for(i in seq(length(unique_district_names)))
{
  ...
  my_name <- paste0("csv/finalDeceasedAG/", my_name_2)
...
write.csv(wave_1_no_na,file = "csv/finalDeceasedAG/Wave1Data.csv", row.names=FALSE)
write.csv(wave_2_no_na,file = "csv/finalDeceasedAG/Wave2Data.csv", row.names=FALSE)
write.csv(mid_wave_no_na,file = "csv/finalDeceasedAG/MidWaveData.csv", row.names=FALSE)
write.csv(final_ratio_df_for_file, file = "csv/finalDeceasedAG/AgeBinDataWaveWise.csv", row.names=FALSE)
write.csv(wave_conf_df,file = "csv/finalDeceasedAG/WaveWiseStatisticsAcrossDistricts.csv", row.names=FALSE)
write.csv(df,file = "csv/finalDeceasedAG/DataWithWaveCategory.csv", row.names=FALSE)
write.csv(death_cnt_df,file = "csv/finalDeceasedAG/DeathCountAcrossWavesDistrictWise.csv", row.names=FALSE)
write.csv(df_new, file = "csv/finalDeceasedAG/DataWithAgeWiseCategory.csv", row.names=FALSE)
