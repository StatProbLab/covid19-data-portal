###############################################################################
## Title: Tripura Warning                                                    ##
## Input: "earlywarning/DISTRICTINF TR.xlsx"           	                     ##
## Output: NA                                                                ##
...
data<- read_excel("earlywarning/DISTRICTINF TR.xlsx")
...
df1=subset(data,data$DISTRICTCODE=="616")
df2=subset(data,data$DISTRICTCODE=="617")
df3=subset(data,data$DISTRICTCODE=="618")
df4=subset(data,data$DISTRICTCODE=="619")
df5=subset(data,data$DISTRICTCODE=="620")
df6=subset(data,data$DISTRICTCODE=="621")
df7=subset(data,data$DISTRICTCODE=="622")
df8=subset(data,data$DISTRICTCODE=="623")


District<- rep("Dhalai",length(nrow(df1)))
df1$District <-District

District<- rep("Gomati",length(nrow(df2)))
df2$District <-District

District<- rep("Khowai",length(nrow(df3)))
df3$District <-District

District<- rep("North Tripura",length(nrow(df4)))
df4$District <-District

District<- rep("Sepahijala",length(nrow(df5)))
df5$District <-District

District<- rep("South Tripura",length(nrow(df6)))
df6$District <-District

District<- rep("Unokoti",length(nrow(df7)))
df7$District <-District

District<- rep("West Tripura",length(nrow(df8)))
...
#j=2
  ...
  #prediction date=1
  df_k=subset(df_f,df_f$Date>="2020-06-01"&df_f$Date<"2020-07-20")
  ...
  #prediction date=2
  df_k1=subset(df_f,df_f$Date>="2020-07-10"&df_f$Date<"2020-08-20")
  ...
  #prediction date=3
  df_k2=subset(df_f,df_f$Date>="2020-08-20"&df_f$Date<"2020-10-10")
  ...
  #prediction date=5
  df_k4=subset(df_f,df_f$Date>="2021-04-20"&df_f$Date<"2021-05-30")
  ...
  #prediction date=6
  df_k5=subset(df_f,df_f$Date>="2021-05-10"&df_f$Date<"2021-07-20")
