###############################################################################
## Title: Jharkhand Analysis                                                 ##
## Input: earlywarning/DISTRICTINF JH.xlsx                                   ##
## Output: csv/critical/[j]-prediction.csv,                                  ##
## graphs/JHwarning/[j]-JH_lamda_t_plots.html                                ##
...
data<- read_excel("earlywarning/DISTRICTINF JH.xlsx")
...
df1=subset(data,data$DISTRICTCODE=="395")
df2=subset(data,data$DISTRICTCODE=="396")
df3=subset(data,data$DISTRICTCODE=="397")
df4=subset(data,data$DISTRICTCODE=="398")
df5=subset(data,data$DISTRICTCODE=="399")
df6=subset(data,data$DISTRICTCODE=="400")
df7=subset(data,data$DISTRICTCODE=="401")
df8=subset(data,data$DISTRICTCODE=="402")
df9=subset(data,data$DISTRICTCODE=="403")
df10=subset(data,data$DISTRICTCODE=="404")
df11=subset(data,data$DISTRICTCODE=="405")
df12=subset(data,data$DISTRICTCODE=="406")
df13=subset(data,data$DISTRICTCODE=="407")
df14=subset(data,data$DISTRICTCODE=="408")
df15=subset(data,data$DISTRICTCODE=="409")
df16=subset(data,data$DISTRICTCODE=="410")
df17=subset(data,data$DISTRICTCODE=="411")
df18=subset(data,data$DISTRICTCODE=="412")
df19=subset(data,data$DISTRICTCODE=="413")
df20=subset(data,data$DISTRICTCODE=="414")
df21=subset(data,data$DISTRICTCODE=="415")
df22=subset(data,data$DISTRICTCODE=="416")
df23=subset(data,data$DISTRICTCODE=="417")
df24=subset(data,data$DISTRICTCODE=="418")



District<- rep("Bokaro",length(nrow(df1)))
df1$District <-District

District<- rep("Chatra",length(nrow(df2)))
df2$District <-District

District<- rep("Deoghar",length(nrow(df3)))
df3$District <-District

District<- rep("Dhanbad",length(nrow(df4)))
df4$District <-District

District<- rep("Dumka",length(nrow(df5)))
df5$District <-District

District<- rep("East Singhbhum",length(nrow(df6)))
df6$District <-District

District<- rep("Garhwa",length(nrow(df7)))
df7$District <-District

District<- rep("Giridih",length(nrow(df8)))
df8$District <-District

District<- rep("Godda",length(nrow(df9)))
df9$District <-District

District<- rep("Gumla",length(nrow(df10)))
df10$District <-District

District<- rep("Hazaribag",length(nrow(df11)))
df11$District <-District

District<- rep("Jamtara",length(nrow(df12)))
df12$District <-District

District<- rep("Khunti",length(nrow(df13)))
df13$District <-District

District<- rep("Koderma",length(nrow(df14)))
df14$District <-District

District<- rep("Latehar",length(nrow(df15)))
df15$District <-District

District<- rep("Lohardaga",length(nrow(df16)))
df16$District <-District

District<- rep("Pakur",length(nrow(df17)))
df17$District <-District

District<- rep("Palamu",length(nrow(df18)))
df18$District <-District

District<- rep("Ramgarh",length(nrow(df19)))
df19$District <-District

District<- rep("Ranchi",length(nrow(df20)))
df20$District <-District

District<- rep("Sahibganj",length(nrow(df21)))
df21$District <-District

District<- rep("Seraikela Kharsawan",length(nrow(df22)))
df22$District <-District

District<- rep("Simdega",length(nrow(df23)))
df23$District <-District

District<- rep("West Singhbhum",length(nrow(df24)))
...
#j=15
  ...
  #prediction date=1
  df_k=subset(df_f,df_f$Date>="2020-06-10"&df_f$Date<"2020-07-20")
  ...
  #prediction date=2
  df_k1=subset(df_f,df_f$Date>="2020-07-20"&df_f$Date<"2020-08-30")
  ...
  #prediction date=3
  df_k2=subset(df_f,df_f$Date>="2020-08-10"&df_f$Date<"2020-10-10")
  ...
  #prediction date=4
  df_k3=subset(df_f,df_f$Date>="2021-03-10"&df_f$Date<"2021-04-30")
  ...
  #prediction date=6
  df_k5=subset(df_f,df_f$Date>="2021-04-15"&df_f$Date<"2021-05-20")
